...
ALTER TYPE public.account_type OWNER TO server342fc;
...
--First query - Insert new record for TAKS 1 of ASSIG 2
...
--Second query - To Modify Tony Stark record for TAKS 1 of ASSIG 2
UPDATE public.account
SET account_type = 'Admin'
WHERE account_firstname = 'Tony'
    AND account_lastname = 'Stark';
--Third query - To Delete Tony Stark record for TASK 1 of ASSIG 2
DELETE FROM public.account
WHERE account_firstname = 'Tony'
    AND account_lastname = 'Stark';
--Fourth query - To Modify GM HUMMER record for TASK 1 of ASSIG 2
